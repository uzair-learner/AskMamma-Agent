...
from askmamma.tools import demo_item_lookup, demo_partner_lookup, demo_reorder_recommendations, demo_status
...
def build_inventory_agent() -> AgentDefinition:
    return AgentDefinition(
        name="InventoryAgent",
        system_prompt=(
            "You are the AskMamma inventory specialist. Use tool evidence for stock, item, partner, and "
