...
from askmamma.tools import demo_forecast, demo_reorder_recommendations, write_demo_report
...
def build_reporting_agent() -> AgentDefinition:
    return AgentDefinition(
        name="ReportingAgent",
        system_prompt=(
            "You are the AskMamma reporting specialist. Package specialist outputs into concise TXT, JSON, "
