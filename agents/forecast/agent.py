...
from askmamma.tools import demo_forecast, demo_history, demo_reorder_recommendations
...
def build_forecast_agent() -> AgentDefinition:
    return AgentDefinition(
        name="ForecastAgent",
        system_prompt=(
            "You are the AskMamma forecasting specialist. Use historical sample data to explain moving "
