"""SQLite data layer for the Inventory Pilot AI agent system."""
...
from inventory_pilot_ai.api.security import hash_password


load_dotenv()

ROOT_DIR = Path(__file__).resolve().parents[3]
DB_PATH = ROOT_DIR / "inventory_pilot_ai.db"
...
def initialize_database() -> None:
    """Create Inventory Pilot AI demo data, memory, tracing, and document tables."""
