"""Streamlit frontend for the Inventory Pilot AI learning project."""
...
st.set_page_config(page_title="Inventory Pilot AI Agent", layout="wide")
st.title("Inventory Pilot AI Agent Studio")
...
with left:
    ...
    if button_cols[1].button("Generate report"):
        report = api_get("/reports/inventory-pilot-ai")
